...
> - 本專案正由 ptApp（React）**移植到 Nuxt 4（Vue 3）**；施作脈絡對齊 Nuxt 移植 Phase 0–7，總規格見 [`../plans/2026-06-18-nuxt-migration-master-plan.md`](../plans/2026-06-18-nuxt-migration-master-plan.md)。
...
### 對齊 Nuxt 移植 Phase（總規格 [`../plans/2026-06-18-nuxt-migration-master-plan.md`](../plans/2026-06-18-nuxt-migration-master-plan.md)）
